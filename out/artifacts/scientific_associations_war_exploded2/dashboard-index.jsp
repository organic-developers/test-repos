        ...
        <div class="container-fluid">
                        ...
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-12 text-right">
                                    ...
                                    <div style="font-size: 13px; padding-top: 5px; text-align: center; border-top-width: 1px; border-top-style: solid; margin-top: 11px;">صندوق ریاست
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="tab-content ">
                <div id="home" class="tab-pane fade ">
                    <h3 class="page-header">تایید شده توسط مدیر</h3>

                    <div class="well well-lg" style="border: 2px solid #337AB7;min-height:140px">
                        <div class="row">
                            <div style="direction: rtl;" class="col-lg-8">

                                <h5 style="margin-top: 0px; font-size: 17px;" class="page-header">عنوان: جسله معارف
                                    ورودی های 93 دانشکده کامپیوتر</h5>
                    ...
                    <div class="well well-lg" style="border: 2px solid #337AB7;min-height:140px">
                        <div class="row">
                            <div style="direction: rtl;" class="col-lg-8">
                                ...
                                <h5 style="margin-top: 0px; font-size: 17px;" class="page-header">عنوان: دوره آموزشی
                                    حفاظت</h5>
                ...
                <div id="menu1" class="tab-pane fade  in active">
                    ...
                    <div class="well well-lg hide" style="border: 2px solid #5CB85C;min-height:140px"
                        ...
                        <div class="row">
                            <div style="direction: rtl;" class="col-lg-8">
                                ...
                                <h5 style="margin-top: 0px; font-size: 17px;" class="page-header" data-toggle="modal"
                                    data-target="#myModal"><strong>عنوان: جسله معارف ورودی های 93 دانشکده
                                    کامپیوتر</strong></h5>
                            ...
                            <div style="direction: rtl;" class="col-lg-8">
                                ...
                                <div class="row">
                                    <div class="col-lg-12"><br>
                                        ...
                                        <a href="evaluation.html" class="btn btn-info">نتایج ارزیابی</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-lg-offset-0"><img style="width: 50%; float: left; margin-top: 7px;"
