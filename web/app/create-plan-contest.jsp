...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            <!-- /.row -->
            <div class="row">
                <form class="form-horizontal" role="form" action="/Controller/ServletCreatePlanTrip?type=2"
                            ...
                            <div class="row judge-table">
                                ...
                                <div class="table-row">
                                    <div class="form-group col-xs-2">
                                        <input type="text" class="form-control" name="judge-fName-"
                                               placeholder="نام">
                                    </div>
                                    <div class="form-group col-xs-3">
                                        <input type="text" class="form-control" name="judge-lName-"
                                               placeholder="نام خانوادگی">
                                    </div>
                                    <div class="form-group col-xs-3">
                                        <input type="text" class="form-control" name="judge-fieldOfStudy-"
                                               placeholder="گرایش تحصیلی">
                                    </div>
                                    <div class="form-group col-xs-3">
                                        <input type="text" class="form-control" name="judge-grade-"
