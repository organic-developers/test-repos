...
//                    alert(x);
                    $.post("/Controller/ServletUsersClerk",
                            {
                                id: x,
                            },
                ...
                <div class="col-lg-4">
                    <div class="panel panel-default" id="test">
                        ...
                        <div class="panel-body">
                            ...
                            <form role="form" action="/Controller/ServletUsersClerk" method="post"
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="associationId" name="associationId" disabled>
