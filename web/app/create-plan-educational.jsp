...
ایجاد طرح (کلاس ها و دوره های آموزشی)
                    </h1>
                </div>
            </div>
            <!-- /.row -->
            ...
            <div class="row">
                <!-- form -->
                <form class="form-horizontal" role="form" action="/Controller/ServletCreatePlanTrip?type=5"
                    ...
                    <!-- attachment file-->
                    <div class="form-group">
                        <label class="control-label col-sm-2" for="resume">رزومه استاد:</label>
