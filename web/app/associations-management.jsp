...
<div id="wrapper">
  ...
  <div id="page-wrapper">
    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div><h3><a href=""><span class="glyphicon glyphicon-plus"></span></a> ایجاد انجمن جدید</h3></div>
        ...
        <div class="row">
          ...
          <div class="col-sm-6 col-md-3">
            <div class="thumbnail">
              <img src="/image/chemistry.gif" alt="..." style="height: 200px; width: 100%; display: block;">
              <div class="caption">
                <h4>انجمن علمی دانشجویی برق</h4>
                <p><a href="#" class="btn btn-primary" role="button">ویرایش</a> <a href="#" class="btn btn-default" role="button">غیر فعال</a></p>
              </div>
          ...
          <div class="col-sm-6 col-md-3">
            <div class="thumbnail">
              <img src="../image/math5.jpg" alt="..." style="height: 200px; width: 100%; display: block;">
              <div class="caption">
                <h4>انجمن علمی دانشجویی برق</h4>
                <p><a href="#" class="btn btn-primary" role="button">ویرایش</a> <a href="#" class="btn btn-default" role="button">غیر فعال</a></p>
              </div>
